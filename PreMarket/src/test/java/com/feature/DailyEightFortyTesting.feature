...
Scenario: Login Navia
  ...
  Scenario: Payin add money in navia    
    ...
    And User Click enter UPI ID "kanniappanb7-1@oksbi" and Click Pay Via UPI
...
Scenario: Verify the Charts Changes in Different Minutes and Days
    When Navigate to home page
       ##And User Choose "TEST123" the Market WatchList
    ...
    #And User Select The "NIFTY" Stock or F&O to Chart
    #And User Click The Current "Sensex" Options
    #And User Select The "SENSEX" Stock or F&O to Chart
