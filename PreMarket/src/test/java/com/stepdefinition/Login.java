...
public class Login extends BaseClass {
	...
	public static void beforeStartTestCase() throws ATUTestRecorderException, InterruptedException {
		...
		Date date = new Date();
		recorder = new ATUTestRecorder("C:\\Users\\CommonPC\\eclipse-workspace\\PreMarket\\VideoRecording",
	...
	public void user_navigate_to_navia() throws InterruptedException, AWTException {
		...
		sleep(1000);
		sendValues(l.getPassWord(), "Trade@123");
...
//	}
	...
	public void user_mouse_over_the_scrip(String string) throws InterruptedException {
		...
		case "Nifty 50":
			...
			WebElement element11 = driver.findElement(By.xpath("(//span[@data-symbol='Nifty 50'])[2]"));
			element11.click();
			Thread.sleep(1000);
	...
	public void user_remove_the_stock(String string) throws InterruptedException {
		...
		driver.findElement(By.xpath("//span[text()='" + string + "']//preceding-sibling::span")).click();
		Thread.sleep(2000);
...
//		}
	...
	public void user_enter_upi_id_mobile_number_and_click_pay_now() throws InterruptedException, AWTException {
		...
		UPI.sendKeys("kanniappanb7-1@oksbi");
		Thread.sleep(1000);
